...
public class ComputerTest extends BaseTest {
    ...
    public void verifyProductAddedToShoppingCartSuccessFully() throws InterruptedException {
        ...
        computer.firstNameField();
        computer.lastNameField();
        computer.emailField();
        computer.countryField();
        computer.cityField();
        computer.address1Field();
        computer.postalCodeField();
        computer.phoneNumberField();
        ...
        computer.cardHolderNameField();
        computer.creditCardNumberField();
        computer.selectExpiryMonthField();
        computer.selectExpiryYearField();
        computer.cardCodeNumberField();
